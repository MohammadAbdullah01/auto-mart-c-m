    ...
    return (
        <div>
            ...
            <div className='shadow-xl p-5'>
                ...
                <p>A state is just a javascript object which holds information of the component which can affect the output of the render function. You can manage the state within the component, and whenever you change the state, React re-renders the component. There are two ways you can change the state: one is using this.state and another one is this.setState.</p>
            </div >
            <div className='shadow-xl p-5'>
                <h1 className='text-xl font-bold'>How does prototypical inheritance work?</h1>
                <p>Prototypal inheritance is a language feature that helps in that. In JavaScript, objects have a special hidden property [ [Prototype]] (as named in the specification), that is either null or references another object.</p>
            </div >
            <div className='shadow-xl p-5'>
                <h1 className='text-xl font-bold'>What is a unit test? Why should write unit tests?</h1>
                <p>Unit testing is one of the software testing types that includes initial testing phase. With unit testing small modules of the program are tested individually. Unit testing is one of the software testing types that includes initial testing phase. The main reason to write unit tests is to gain confidence. Unit tests allow us to make changes, with confidence that they will work. Unit tests allow change.</p>
            </div >
            <div className='shadow-xl p-5'>
                <h1 className='text-xl font-bold'> How will you improve the performance of a React Application?</h1>
                <p>I will improve my React App Performance by Using Throttling and Debouncing Learn how to improve performance by implementing throttling and debouncing with lodash, underscore or RxJs W hen building an app using React, we always have this problem of limiting the number of expensive calls, async network requests and DOM updates.</p>
            </div >
        </div >
    );
};
